...
export function Projects() {
  ...
  async function loadUsers() {
    // Client users should not fetch users list
    if (isClient) {
      setUsers([]);
      return;
    }
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-2 text-xs text-muted-foreground">
                        {/* Hide Client info for CLIENT users */}
                        {!isClient && (
                      ...
                      {/* Hide action buttons for CLIENT users */}
                      {!isClient && (
                        <div className="flex flex-wrap gap-2 pt-2 border-t">
                          ...
                          {/* Hide Members button for employees */}
                          {!isEmployee && (
                            <Button
                              variant="outline"
                              size="sm"
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  {/* Hide Client column for CLIENT users */}
                  {!isClient && (
              ...
              <TableBody>
                {loading ? (
                  Array.from({ length: 5 }).map((_, index) => (
                    <TableRowSkeleton key={index} columns={isClient ? 3 : 5} />
                  ))
                ) : filteredProjects.length === 0 ? (
                  <TableRow>
                    <TableCell
                      colSpan={isClient ? 3 : 5}
                ...
                <AlertDialogDescription>
                  {memberToRemove &&
                    `Are you sure you want to remove ${
                      memberUserMap.get(memberToRemove.userId)?.fullName ||
